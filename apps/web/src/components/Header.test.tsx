...
describe('Header', () => {
  ...
  // SS-H1: Renders sync toggle button with aria-pressed=true
  ...
  // SS-H2: Toggle shows aria-pressed=false when sync disabled
  ...
  // SS-H4: Does not render toggle when props omitted
